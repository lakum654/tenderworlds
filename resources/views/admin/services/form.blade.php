                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <span class="py-5"><input type="radio" name="status" value="1" checked>
                                        Active</span>
                                    <span class="py-34"><input type="radio" name="status" value="0"> In
                                        Active</span>
                                </div>
                            ...
                            <div class="col-6 col-sm-12">
                                <div class="form-group">
                                    <textarea id="ck-editor" class="form-control" style="height: 300px" name="content" placeholder="Write Content..."></textarea>
                                </div>
